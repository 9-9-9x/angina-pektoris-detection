"""
FastAPI Application for Angina Pektoris Prediction
===================================================

A REST API for predicting Angina Pektoris based on patient clinical data.
...
def load_model():
    ...
    try:
        ...
        preprocessing_config = model_data['preprocessing']
        ...
        print("⚠️  WARNING: Model file 'angina_model.pkl' not found!")
...
# Try to load model on module import (for development convenience)
load_model()
